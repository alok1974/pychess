...
class IMAGE:
    ...
    BASE_IMAGE_SIZE = 900
    IMAGE_SIZE = 450
    RESIZE_FACTOR = float(IMAGE_SIZE / BASE_IMAGE_SIZE)
    SQUARE_SIZE = int(104 * RESIZE_FACTOR)
    BORDER_SIZE = int(34 * RESIZE_FACTOR)
    NON_PAWN_IMAGE_SIZE = int(72 * RESIZE_FACTOR)
    PAWN_IMAGE_SIZE = int(64 * RESIZE_FACTOR)
